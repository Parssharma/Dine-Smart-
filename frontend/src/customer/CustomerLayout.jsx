...
export default function CustomerLayout() {
  const { user, isAuthenticated, isCustomer, logout, showAuthModal, authMode, closeAuthModal, openAuthModal } = useAuth();
          ...
          {isCustomerAuth ? (
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              ...
              <button 
                ...
                style={{ padding: '0.35rem 0.85rem', fontSize: '0.82rem', borderRadius: 'var(--radius-full)' }}
              >
                Sign In
              </button>
            </div>
