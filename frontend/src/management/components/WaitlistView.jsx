    ...
    <div className="stitch-dashboard-container flex flex-col gap-4">
      ...
      <div style={{ padding: '0 0.5rem' }}>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
          ...
          <section className="lg:col-span-8 stitch-bento-panel" style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <section className="lg:col-span-4 stitch-bento-panel" style={{ display: 'flex', flexDirection: 'column' }}>
