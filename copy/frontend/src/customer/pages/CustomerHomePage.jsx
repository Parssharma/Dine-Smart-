            ...
            <div className="royal-floating-badge chime">
              ...
              <div>
                <div className="royal-badge-text-primary">
                  {loadingTables ? 'Seating Engine' : `${liveStats.totalSeats} Total Seats`}
                </div>
          ...
          {isAuthenticated && isCustomer && user ? (
            ...
            <>
              ...
              <div className="royal-member-actions">
                ...
                <Link to="/customer/login" className="royal-btn-secondary">
                  <LogIn size={18} />
                  <span>Sign In</span>
                </Link>
              </div>
        ...
        <div className="royal-footer-inner">
          ...
          <div className="royal-footer-links">
            ...
            {isAuthenticated && isCustomer ? (
              ...
              <Link to="/customer/login" className="royal-footer-link">Customer Sign In</Link>
            )}
